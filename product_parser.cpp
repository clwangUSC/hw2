...
{
    Product* b = new Book(prodName_, price_, qty_, isbn_, author_);
    return b;
...
{
    Product* c = new Clothing(prodName_, price_, qty_, size_, brand_);
    return c;    
}
...
{
    Product* m = new Movie(prodName_, price_, qty_, genre_, rating_);
    return m;
